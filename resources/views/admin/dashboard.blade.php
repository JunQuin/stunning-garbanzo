            ...
            <div class="py-3 px-6 border-b border-gray-100 text-gray-200">
                <div class="flex flex-wrap overflow-hidden pt-2">
                    <div class="w-1/3 overflow-hidden">
                        <h2 class="mb-4 mt-2 text-2xl text-white font-bold">Listado de proyectos</h2>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            @isset($proyectosData)
                                @foreach ($proyectosData as $proyecto)
                                    <div
                                        class="flex items-start rounded-xl bg-white p-4 mb-4 shadow-lg {{ $proyecto->pro_categoria }}">
