                ...
                @isset($proyectosData)
                    @foreach ($proyectosData as $proyecto)
                            ...
                            <div class="ml-4 text-gray-900 capitalize">
                                ...
                                <div class="container inline-flex">
                                    ...
                                    <button type="button"
                                        ...
                                        data-mdb-ripple-radius="50" data-bs-target="#staticBackdrop1-{{ $proyecto->pro_id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-file-earmark-plus mr-2" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <button type="button"
                                        ...
                                        data-bs-toggle="modal" data-mdb-ripple="true" data-mdb-ripple-unbound="true"
                                        data-mdb-ripple-radius="50" data-bs-target="#staticBackdrop2-{{ $proyecto->pro_id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-file-earmark-plus mr-2" viewBox="0 0 16 16">
                                            <path
                                                d="M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5z">
                        ...
                        <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
                            id="staticBackdrop1-{{ $proyecto->pro_id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <form id="brocoli-1-{{ $proyecto->pro_id }}" role="form" method="POST"
                                        ...
                                        <div class="flex items-center place-content-center modal-body relative p-4">
                                            <div class="block p-6 rounded-lg shadow-lg bg-white w-9/12">
                                                <input type="hidden" name="proyecto" value="{{ $proyecto->pro_id }}">
                        ...
                        <!-- Modal -->
                        <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
                            id="staticBackdrop2-{{ $proyecto->pro_id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog relative w-auto pointer-events-none">
                                <div
                                    class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                        ...
                        <!-- Modal -->
                        <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
                            id="staticBackdrop3-{{ $proyecto->pro_id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog relative w-auto pointer-events-none">
                                <div
                                    class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
