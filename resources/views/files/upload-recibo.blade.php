                    ...
                    <div class="flex flex-col text-center w-full mb-4">
                        ...
                        <div class="flex items-center justify-center">
                            <div class="b relative mx-auto h-16 w-64 flex justify-center items-center">
                                <a target="_blank" href="{{ route('recibo.show',$file) }}"
            ...
            <div class="flex flex-col text-center w-full mb-4">
                ...
                <div class="card">
                    <div class="card-header mb-2">
                        Favor de cargar su recibo de pago en PDF o formato de imagen PNG o JPG
                    </div>
                    <div class="card-body">
                        <form class="container rounded" role="form" method="POST"
                              action="{{ route('recibo.store') }}" accept-charset="UTF-8"
                                ...
                                <div class="flex justify-center">
                                    <div class="mb-3 w-96">
                                        <input
                                            ...
                                            type="file" name="formFile" id="formFile" accept="application/pdf,image/jpeg,image/jpg,image/png">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
